...
function visibleTextField() {
	var val = document.getElementById('going_away_change_place').value;
	if(val == 0) {
		document.getElementById('going_away_textfield').setAttribute('style', 'display:block');
	}else{
		document.getElementById('going_away_textfield').setAttribute('style', 'display:none');
	}
}
